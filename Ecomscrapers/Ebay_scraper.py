# scrapes listingname,link,price sold, shipping cost. outputs to csv.
...
class User(object):
    ...
    def searchItem(self, url, search, ofile):
        ...
        # set url to show only SOLD listings
        newurl = self.br.geturl() + "&LH_Complete=1&LH_Sold=1"
...
if __name__ == "__main__":
    ...
    with open("EbayitemList.txt") as f:
        item = f.readline()
        while item:
            thing = item
            thing.split()
